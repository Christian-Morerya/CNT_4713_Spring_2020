/* MySQL script
   ...
   Phase 1: Drop all six tables of Henry database if they exist
...
/* Phase 2: Create all six empty tables of Henry database */

-- create a new empty table Author
CREATE TABLE Author 
...
-- create a new empty table Publisher
...
-- create a new empty table Inventory
...
-- create a new empty table Wrote
CREATE TABLE Wrote 
( BookCode CHAR(4) not null,
  AuthorNum DECIMAL(2,0) not null,
  ...
  constraint WroteBook_fk
    foreign key (BookCode) references Book(BookCode),
  constraint WroteAuth_fk
    foreign key (AuthorNum) references Author(AuthorNum)
);


/* Phase 3: Add rows of data to each of these six empty tables of Henry DB */

-- Insertion of twenty five Author rows
INSERT INTO Author
VALUES
(1,'Morrison','Toni');
INSERT INTO Author
...
-- Insertion of twenty eight Publisher rows
...
-- Insertion of thirty three Book rows
INSERT INTO Book
VALUES
...
-- Insertion of thirty six Wrote rows
INSERT INTO Wrote
VALUES
('0180',3,1);
INSERT INTO Wrote
